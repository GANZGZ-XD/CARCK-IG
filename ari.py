...
def login():
	...
	if x.get('status')=='success':
		...
		print(f'\n{H}>{C} Lojin Gak Cp Mek')
		os.system('python login.py')
	elif x.get('status')=='checkpoint':
		exit(f'{M}>{C} mampus tumbal cp awokawok')
	else:
		exit(f'{M}!{C} Username atau password yang anda masukan salah kentod')
...
class instagram:
  ...
  /  _  \\______   \    |Created By:ARIANDI XD.     
 /  /_\  \|       _/   |Gans biar dpt hasil:v
/    |    \    |   \   |
\____|__  /____|_  /___|
        \/       \/     
     
{B}[*]----------------------------------------------
{B}[*]    Sebuah tools untuk henk akun ig:v
{B}[*]    Jangan lupa bahagia:)
{B}[*]----------------------------------------------

{H}[01] Crack dari pencarian nama public
{H}[02] Crack dari pengikut public
{H}[03] Crack dari mengikuti public
{M}[04] Crack ulang hasil crack
{M}[05] Check hasil crack
{M}[06] Bot auto unfollow
...
{M}[08] Keluar
 ...
 [{M}!{C}] nyalakan mode pesawat  setiap 2 menit tod
  ...
  {M}*->{C} 😂 Awokawok login checkpoint
  {M}*->{C} Makanya gans biar dapet ok:v
					""")
